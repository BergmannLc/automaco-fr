# -*- coding: utf-8 -*-
"""
Etapa 12 - Delete Fora de Rota (Padronizado)
Abre o arquivo 03 - Fora de Rota.xlsx e exclui todas as linhas de 2 até 20000.
...
XLSX_PATH = r"\\192.168.254.64\Grupo Fast\SAR\6. Fora de Rota\Google Maps\03 - Fora de Rota.xlsx"

def main():
    print("=== ETAPA 12 - DELETE FORA DE ROTA (PADRÃO 2→20000) ===")
