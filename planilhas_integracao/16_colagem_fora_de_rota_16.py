# -*- coding: utf-8 -*-
"""
Etapa 15 - Colagem Fora de Rota
Abre o arquivo 11 - Fora de Rota automatico - NOVEMBRO.xlsm (aba COORDENADAS)
e copia os valores das colunas S até Y (linhas 8 até o final).
Depois, cola como número na planilha 03 - Fora de Rota.xlsx a partir da linha 2 da coluna A.
...
SRC_PATH = fr"\\192.168.254.64\Grupo Fast\SAR\6. Fora de Rota\Fora de rota - {ano_atual}\{mes_num} - Fora de Rota automatico - {mes_traduzido}.xlsm"
DST_PATH = r"\\192.168.254.64\Grupo Fast\SAR\6. Fora de Rota\Google Maps\03 - Fora de Rota.xlsx"

def main():
    print("=== ETAPA 15 - COLAGEM FORA DE ROTA ===")
    ...
    try:
        ...
        # Identifica última linha da origem (base na coluna S)
        last_row = ws_src.Cells(ws_src.Rows.Count, "S").End(-4162).Row  # xlUp
        if last_row < 8:
        ...
        # Copia colunas S:Y da origem
        src_range = ws_src.Range(f"S8:Y{last_row}")
